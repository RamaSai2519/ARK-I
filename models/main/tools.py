...
class MainTools:
    ...
    def handle_function_call(self, function_name: str, arguments: str) -> str:
        ...
        function_map = {
            ...
            "ExpertsAssistant": lambda args: self.controller.invoke_model('expert', args.get('query')),
            "ServicesAssistant": lambda args: self.controller.invoke_model('sukoon', args.get('query'))
        }
